...
import { Window as HappyDomWindow, GlobalWindow }from 'happy-dom';
...
export function buildPal(): { global: IGlobal, platform: IPlatform, dom: IDom, feature: IFeature } {
  ...
  var happyDom = new HappyDomWindow({ url: "http://localhost/" }) as unknown as Window;
  //var global: IGlobal = <IGlobal>jsdom.window;
  var global: IGlobal = <IGlobal>happyDom;

  ensurePerformance(global.window);

  var platform = new NodeJsPlatform(global, happyDom as unknown as HappyDomWindow);
